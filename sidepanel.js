...
// document.addEventListener("DOMContentLoaded", () => {
//   statusDiv.textContent = "Checking AI model status...";
//   // Ask the service worker to check the status via the offscreen doc
//   chrome.runtime.sendMessage({ action: "checkAIModelStatus" });
// });

// // 2. Listen for status updates from the offscreen document
// chrome.runtime.onMessage.addListener((message) => {
//   if (message.action === "ai-status-update") {
//     updateStatus(message.status, message.error);
//   }
...
//       break;
//     case "unavailable":
//       statusDiv.textContent = `Error: AI is unavailable. ${error}`;
//       processButton.disabled = true;
//       processButton.textContent = "AI Unavailable";
//       break;
//     case "processing":
...
// // This script handles the logic for the UI in sidepanel.html.
...
//     },
//     (response) => {
//       // This callback can handle a response from the service worker if needed.
//       if (chrome.runtime.lastError) {
//         statusDiv.textContent = "Error: " + chrome.runtime.lastError.message;
//       } else {
//         statusDiv.textContent = "Action sent to page.";
//       }
//     }
//   );
// });
